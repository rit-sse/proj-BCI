...
import spriteArrayPng from './assets/offline-sprite-1x.png';
...
const spriteArrayImg = new Image();
spriteArrayImg.src = spriteArrayPng;
const bgImg = new Image();
bgImg.src = spriteArrayPng;
const brickImg = new Image();
brickImg.src = spriteArrayPng;
const fgImg = new Image();
fgImg.src = spriteArrayPng;
const pipeNorthImg = new Image();
pipeNorthImg.src = spriteArrayPng;
const pipeSouthImg = new Image();
pipeSouthImg.src = spriteArrayPng;
